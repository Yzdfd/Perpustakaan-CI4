	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	    <ul class="nav menu">
	        <li class="active"><a href="<?= base_url('admin/dashboard-admin');?>"><span
	            ...
	            <ul class="children collapse" id="sub-item-1">
	                ...
	                <li>
	                    <a class="" href="<?= base_url('admin/master-data-kategori');?>">
	                        <span class="glyphicon glyphicon-share-alt"></span> Buku Kategori
	                    </a>
	                </li>
	                <li>
	                ...
	                <li>
	                    <a class="" href="<?= base_url('admin/master-data-buku-buku');?>">
